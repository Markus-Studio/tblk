...
export class Compiler extends AbstractParseTreeVisitor<SourceNode>
  ...
  visitDocument(context: Parser.DocumentContext) {
    ...
    if (this.options.mode === 'iife') {
      ...
      if (this.options.typescript) {
        return new SourceNode(null, null, null, [
          '// TBLK AUTOGENERATED FILE, DO NOT MODIFY.\n',
          'import { Writer } from "tblk/src/writer";\n\n',
          'export default function render($: Record<string, any> = {}) {\n',
          ...body,
          '}'
        ]);
      }
      return new SourceNode(null, null, null, [
        '// TBLK AUTOGENERATED FILE, DO NOT MODIFY.\n',
        'const { Writer } = require("tblk/dist/src/writer");\n\n',
  ...
  visitPartialBegin(context: Parser.PartialBeginContext) {
    ...
    return this.text(context, [
      ...
      this.options.typescript ? '($: Record<string, any>) {\n' : '($) {\n',
      this.indention,
      '$.__proto__ = root;\n',
      this.indention,
      'w.push();\n'
